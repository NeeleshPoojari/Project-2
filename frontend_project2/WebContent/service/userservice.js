...
app.factory('UserService', function($http) {
	...
	userService.registerUser = function(user) {
		return $http.post(
				"http://localhost:8080/backend_project2/registration", user)
	}
	...
	userService.getUserByUsername = function() {
		...
		return $http
				.get("http://localhost:8080/backend_project2/getuserdetails")
	}

	userService.updateUserProfile = function(user) {

		return $http.put(
				"http://localhost:8080/backend_project2/updateprofile", user)
	}
